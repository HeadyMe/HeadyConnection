...
class ServiceConfig:
    ...
    vertical_type: str = os.getenv("VERTICAL_TYPE", "Junior")
    endpoint_url: str = os.getenv("ENDPOINT_URL", "http://heady-junior:8000")
    policy_version: str = os.getenv("POLICY_VERSION", "2025-01-01")
    register_timeout_s: float = float(os.getenv("REGISTER_TIMEOUT_S", "2.5"))
    parental_token: str = os.getenv("PARENTAL_TOKEN", "parent-override")
